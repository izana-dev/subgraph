...
export class NFTRoyaltyFeeUpdate extends ethereum.Event {
  get params(): NFTRoyaltyFeeUpdate__Params {
    return new NFTRoyaltyFeeUpdate__Params(this);
  }
}

export class NFTRoyaltyFeeUpdate__Params {
  _event: NFTRoyaltyFeeUpdate;

  constructor(event: NFTRoyaltyFeeUpdate) {
    this._event = event;
  }
...
export class RoyaltyFeeRegistry extends ethereum.SmartContract {
  ...
  royaltyInfo(
    ...
    let result = super.call(
      "royaltyInfo",
      "royaltyInfo(address,uint256,uint256):(address,uint256)",
      [
        ethereum.Value.fromAddress(collection),
...
export class UpdateRoyaltyInfoForNFTCollectionCall extends ethereum.Call {
  get inputs(): UpdateRoyaltyInfoForNFTCollectionCall__Inputs {
    return new UpdateRoyaltyInfoForNFTCollectionCall__Inputs(this);
  }

  get outputs(): UpdateRoyaltyInfoForNFTCollectionCall__Outputs {
    return new UpdateRoyaltyInfoForNFTCollectionCall__Outputs(this);
  }
}

export class UpdateRoyaltyInfoForNFTCollectionCall__Inputs {
  _call: UpdateRoyaltyInfoForNFTCollectionCall;

  constructor(call: UpdateRoyaltyInfoForNFTCollectionCall) {
    this._call = call;
  }
...
export class UpdateRoyaltyInfoForNFTCollectionCall__Outputs {
  _call: UpdateRoyaltyInfoForNFTCollectionCall;
